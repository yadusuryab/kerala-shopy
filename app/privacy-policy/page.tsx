...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Privacy Policy - KeralaShopy Store</title>
        <meta name="description" content="Read the privacy policy of KeralaShopy Store to understand how we handle your data." />
      </Head>
      <div className="container mx-auto p-6">
        <h1 className="text-3xl font-bold mb-4">Privacy Policy</h1>
        <p>At KeralaShopy Store, we are dedicated to protecting your privacy and securing the personal information you provide. This Privacy Policy outlines our practices regarding the collection, use, and sharing of your data when you visit our website or make purchases.</p>
