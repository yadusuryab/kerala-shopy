...
export default function CookiesPolicy() {
  return (
    <>
      <Head>
        <title>Cookies Policy - KeralaShopy</title>
        <meta name="description" content="Learn how KeralaShopy uses cookies to enhance your browsing experience." />
      </Head>
      <div className="container mx-auto p-6">
        ...
        <ul className="list-disc ml-6">
          <li>
            <strong>Company:</strong> Refers to KeralaShopy ("the Company", "We", "Us", or "Our").
          </li>
          <li>
          ...
          <li>
            <strong>Website:</strong> Refers to KeralaShopy, accessible from
            <a href="https://KeralaShopy.co.in" target="_blank" rel="noopener noreferrer" className="text-blue-500"> KeralaShopy.co.in</a>.
          </li>
          <li>
        ...
        <h3 className="text-xl font-semibold mt-4">Your Choices Regarding Cookies</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-4">More Information about Cookies</h3>
        <p>
        ...
        <p>
          ...
          <a
            href="https://KeralaShopy.co.in/contact"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-500"
          >
            KeralaShopy.co.in/contact
          </a>
          .
        </p>
      </div>
